    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAnswer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                        Toast.makeText(scientificCalculatorActivity.this , "Clicked w" , Toast.LENGTH_SHORT).show();
    ...
    private void obtainInputValues(String input){
        switch (input){
            ...
            case "ABS":
                ...
                break;
            case "MR":
                String mValue = getStoredPreferenceValue(scientificCalculatorActivity.this);
                ...
                break;
            case "MS":
                clearMemoryStorage(scientificCalculatorActivity.this);
                break;
            case "M+":
                if (isInverse){
                    double inputValueMinus  = isANumber(outputResult.getText().toString());
                    if(!Double.isNaN(inputValueMinus)){
                        subtractMemoryStorage(scientificCalculatorActivity.this, inputValueMinus);
                    }
                }else{
                    double inputValue  = isANumber(outputResult.getText().toString());
                    if(!Double.isNaN(inputValue)){
                        addToMemoryStorage(scientificCalculatorActivity.this, inputValue);
                    }
                }
                toggleInverse();
                toggleShiftButton();
    ...
    public void onClick(View view) {
        ...
        if(data.equals("AC")){
            ...
            if (resultObject != null) {
                ...
                Toast.makeText(scientificCalculatorActivity.this , "No Answer found" , Toast.LENGTH_SHORT).show();
            }
